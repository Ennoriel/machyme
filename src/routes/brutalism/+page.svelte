...
<div class="wrapper">
	...
	<div class="black">
		<h1>
			...
			<div class="compact" style:--s="22.2vw" style:--m="11.0vw">DUPONT</div>
		</h1>
	</div>
	<div class="laptop" />
	<div />
	<div class="black">
		<p style:margin-top="0">experienced</p>
		<p>senior</p>
		<p style:margin-bottom="0">developer</p>
	</div>
	<div class="mobile" />
	<div class="black">
		<h2 class="comh2act" style:--s="19.8vw" style:--m="9.8vw">services</h2>
		<p>create</p>
		<p>extend</p>
		<p>review</p>
		<p style:--s="3.7vw" style:--m="1.9vw" style:margin-bottom="0">
			I do everything for &nbsp;<strong
				style:--s="7.7vw"
				style:--m="3.8vw"
				style:line-height="1.9vw">your website</strong
			>
		</p>
	</div>
	<div class="laptop" />
	<div />
	<div class="black">
		<pre class="center" style:--s="0.8vw" style:--m="0.4vw" aria-hidden="true">{glasses}</pre>
		<h2 class="compact" style:--s="17.8vw" style:--m="8.8vw">Expertise</h2>
		<p>SEO</p>
		<p>accessibility</p>
		<p>reusability</p>
		<p style:margin-bottom="0">user experience</p>
	</div>
	<div class="mobile" />
	<div class="black" style:padding="0 4px">
		...
		<p style:margin="0 0 4px" style:border-bottom="2.5px solid white">
			<a
				...
				>Learn more about&nbsp;<span class="mobile">&nbsp;&nbsp;</span><span
					style:--s="9.1vw"
					style:--m="4.5vw"
					style:line-height="2.3vw"
					style:transform="scaleY(1.5)"
					style:margin-bottom="-2vw">Brutalism</span
				></a
			>
		</p>
	</div>
...
<style>
	* {
	...
	.black:hover {
		animation: color-rotate 4s linear 0s infinite;
	}
